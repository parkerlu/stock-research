...
⚠️ 2026-09-06 起不进任何训练指标。原因: 龙虎榜盘后公布, 这些票次日平均高开
1.31%,「10日涨10%」命中率从 41.53%(收盘基准)掉到 37.22%(可交易基准) ——
好看的那部分买不到。它只做两件事: 本页的每日榜单, 和 K 线上的上榜标记。

最有价值的一档仍是 **当日涨幅 −2~2% 却上了榜**(价格没动却有大额资金进出),
但这归人工判断, 不做成信号。
"""
