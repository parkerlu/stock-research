...
_SEED_META: dict[str, dict] = {
    ...
    "mmhz": {"concept": "买卖很准", "family": "MaimaiZhun",
             "description": "合并版纯指标: 买=超卖结束回落沿, 卖=强势破位回归沿 (与副图指标同源)",
             "metrics": {}},
    ...
    "rev-60": {"concept": "反转融合", "family": "Reversal", "description": "极严 thr=0.60",
              "metrics": {}},
    "tdx-triple-gold": {"concept": "TDX经典", "family": "TripleGold", "description": "三金叉共振 MA+MACD+KDJ",
              "metrics": {}},
    "tdx-macd-pit": {"concept": "TDX经典", "family": "MACDGoldPit", "description": "MACD 黄金坑 + 量能放大",
              "metrics": {}},
    ...
    "chan-2buy": {"concept": "缠论", "family": "Chan2Buy", "description": "2 类买点（1 类后回踩不破底）",
              "metrics": {}},
    "chan-12":   {"concept": "缠论", "family": "Chan12", "description": "缠论 1+2 类合并",
              "metrics": {}},
    "chan-1buy-wide": {"concept": "缠论", "family": "Chan1BuyWide", "description": "1 类买点 + 宽 ATR 吃波段",
              "metrics": {}},
