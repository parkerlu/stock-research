...
_SEED_META: dict[str, dict] = {
    ...
    "mm-40": {"concept": "买卖很准", "family": "MaimaiFilter", "description": "买卖很准过滤 thr=0.40",
              "metrics": {"trades": "filter score >= 0.40"}},
    "mm-50": {"concept": "买卖很准", "family": "MaimaiFilter", "description": "买卖很准过滤 thr=0.50 (603319: 87.5% 胜率)",
              "metrics": {"is_win": 87.5, "trades": "score >= 0.50"}},
    "mm-55": {"concept": "买卖很准", "family": "MaimaiFilter", "description": "买卖很准过滤 thr=0.55 (603319: 4/4 全胜)",
              "metrics": {"is_win": 100.0, "trades": "score >= 0.55"}},
